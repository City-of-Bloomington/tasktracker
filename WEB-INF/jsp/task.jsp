...
<s:form action="task" id="form_id" method="post" >
  ...
  <p>* Required field <br />
	...
	Note: checking completed 100% will close the request, no further action is needed. <br />
		You may add time spent on this task (in hours), and estimated expenses, normally hours multiply by your hourly rate in the related fields.<br />
	...
	<div class="tt-row-container">
		<s:if test="task.id != ''">
			...
			<dl class="fn1-output-field">
				<dt>Request </dt>
				<dd><a href="<s:property value='#application.url' />request.action?id=<s:property value='task.request_id' />"><s:property value="task.request_id" /></a>
				</dd>
			</dl>		
			<dl class="fn1-output-field">
			<dt>Head Line </dt>
		...
		<dl class="fn1-output-field">
			<dt>Completed (%)</dt>
			<dd><s:radio name="task.completed" value="%{task.completed}" list="#{'0':'0%','25':'25%','50':'50%','75':'75%','100':'100%'}" /> </dd>
		</dl>
		<s:if test="task.id == ''">
